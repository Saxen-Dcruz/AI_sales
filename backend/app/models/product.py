...
from app.database.core  import Base # Assuming you have a standard SQLAlchemy Base
...
class ProductEmbedding(Base):
    ...
    chunk_type = Column(String) # e.g., 'specification', 'feature', 'application'
    text_content = Column(Text) # The actual text the LLM will read
    
    # BAAI/bge-m3 outputs 1024 dimensions
