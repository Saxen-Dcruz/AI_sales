...
import {
  RefreshCw, Search, Mail, MailOpen, AlertCircle, Clock,
  CheckCircle, Archive, Send, Users, Star, Tag, ChevronRight,
  X, Zap, ThumbsUp, ThumbsDown, Minus, ExternalLink
} from 'lucide-react'
import { GetGmailMessagesService, SyncGmailService, ApproveDraftService, ResolveEmailService, DiscardDraftService } from '../services/ApiService'
...
const SENTIMENT_CONFIG = {
  ...
  NEUTRAL:     { icon: Minus,      color: 'text-gray-400',    bg: 'bg-gray-50',    label: 'Neutral' },
  FRUSTRATED:  { icon: ThumbsDown, color: 'text-red-500',     bg: 'bg-red-50',     label: 'Frustrated' },
}
